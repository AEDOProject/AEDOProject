...
<aedo:admintemplate title="${requestScope.trainingtype.trainingtypename }">
					...
					<div class="page-header-content">
						...
						<div class="heading-elements">
							<div class="heading-btn-group">
								<button title="แก้ไขคำอธิบาย" id="edit" class="btn btn-primary btn-icon btn-rounded" type="button">
									...
									<button class="btn btn-default btn-icon btn-rounded" id="cancel"><i class="icon-x"></i></button>
							</div>
						</div>
					</div>
					</div>
	...
	<jsp:attribute name="content">
		<div class="panel panel-flat"> 
			...
			<div id="detail" class="panel panel-flat fr-view" style="padding: 20px;margin:20px;">
			<!-- Contents -->
				${requestScope.trainingtype.detail }		
			</div>
