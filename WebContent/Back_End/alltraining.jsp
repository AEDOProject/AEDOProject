                    ...
                    <div class="page-header"> 
                        <div class="page-header-content"> 
                            <div class="page-title"> 
                                <h4><button title="New File" class="btn btn-info btn-float btn-rounded pull-right" type="button" data-toggle="modal" data-target="#fileModal"> 
                                        <i class="icon-plus3"></i> 
                                    </button><span class="gb_Rb"></span><span class="text-semibold">  File</span></h4> 
                                <!--File Modal -->                                 
                                    ...
                                    <div class="modal-dialog" role="document"> 
                                        <div class="modal-content"> 
                                            <div class="modal-header"> 
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">New Training</h4> 
                                            </div>           
                                ...
                                <fieldset class="content-group">
									<div class="row form-group">
										...
										<div class="col-md-8">
												<input type="text" class="form-control" placeholder="Training Project Name">
                                    ...
                                    <div class="row form-group">
										...
										<div class="col-md-8">
												<input type="submit" class="btn btn-success btn-lg" value="Add new Training">
                    ...
                    <div class="content"> 
                        ...
                        <div class="panel panel-flat"> 
                            <div class="panel-heading"> 
                                <h5 class="panel-title"> <i class="icon-files-empty2"></i> All File</h5> 
