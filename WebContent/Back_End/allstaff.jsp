				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title"> <i class="icon-users2"></i> All Staff</h5>
						...
						<table class="table datatable-basic">
							...
							<tbody>
								...
								<tr>
									...
									<td>Jackelyn</td>
									<td>Weible</td>
									<td><a href="#">0811111111</a></td>
									
									<td><span class="label label-default">Staff</span></td>
									<td class="text-center">
										<ul class="icons-list">
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<tr>
									...
									<td><span class="label label-danger">Staff</span></td>
									<td class="text-center">
										<ul class="icons-list">
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown">
