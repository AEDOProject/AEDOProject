                            ...
                            <div class="category-content no-padding">
                                <ul class="navigation navigation-main navigation-accordion">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#myModal" data-toggle="modal"><i class="icon-plus3"></i>New Albums</a> 
                                            </li>
                                            <li>
                                                <a href="allgallery.html"><i class="icon-images3"></i>All Albums</a>
                                            </li>
                                            <li>
</li>
                                            <li>
                    ...
                    <div class="page-header">
                        <div class="page-header-content">
                            <div class="page-title">
                                <h4><button title="Add Photo" class="btn btn-info btn-float btn-rounded pull-right" type="button" data-toggle="modal" data-target="#myModal">
                                        <i class="icon-plus3"></i>
                                    </button><span class="gb_Rb"></span><span class="text-semibold">Gallery</span> - Media Library</h4>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label text-semibold">Select photo for upload:</label>
                                                    <div class="col-lg-9     ">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-condensed list-unstyled no-margin"> 
                                                <li>
                                                    <span class="text-semibold">Size:</span> 215 Kb
                                                </li>
                                                <li>
                                                    <span class="text-semibold">Format:</span> .jpg
                                                </li>
                                            </ul>
                                        </td>
                                        <td class="text-center">
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            <a href="#"><i class="icon-pencil7"></i> Edit file</a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><i class="icon-copy"></i> Copy file</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="#"><i class="icon-bin"></i> Move to bin</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
