			...
			<div class="container">
				<div class="row">
					...
					<div class="9u skel-cell-important">
						<section>
							<p style="font-size:36px; font-weight:bold;">Trainings for New Faculty Staff</p>
                             ...
                             <center>
                              ...
                              <table class="table table-hover">
                                ...
                                <tr style="font-family:'Thai Sans Lite'; font-weight:bold; font-size:14pt;">
                                    ...
                                    <th style="width:10%;"><center>จำนวนรับ</center></th>
                                    <th style="width:10%;"><center>วัน เวลา และสถานที่</center></th>
                                    <th style="width:10%;"><center>ช่วงเวลาที่รับสมัคร</center></th>
                                    <th style="width:12%;"><center>ลงทะเบียนเข้าร่วมอบรม/กิจกรรม</center></th>                                     
                                    <th style="width:13%;"><center>รายชื่อผู้เข้าร่วมอบรม/กิจกรรม</center></th>
                                    <th style="width:15%;"><center>ประวัติวิทยากร</center></th>
                                </tr>                                     
                                </thead>
                                <tbody>
                                  <tr>
                                    <td>1. การซ้อมสอนเป็นภาษาอังกฤษ (Teaching Rehearsal) ประจำปีงบประมาณ พ.ศ 2558</td>
                                    <td>การอบรมเชิงปฏิบัติการการสอนที่เน้นผู้เรียนเป็นสำคัญโดยใช้ภาษาอังกฤษเป็นสื่อกลาง </td>
                                    <td>50</td>
                                    <td>ยังไม่ระบุวัน</td>
                                    <td></td>
                                    <td>ยังไม่เปิดระบบลงทะเบียน</td>
                                    <td><a href="#"></a></td>
                                    <td></td>  
                                  </tr>
                                  <tr>
                                    <td>2. โครงการสัมมนาอาจารย์ใหม่ ประจำปีงบประมาณ พ.ศ 2558 </td>
                                    <td>กิจกรรมสำหรับอาจารย์ใหม่ทุกคนในการเรียนรู้บทบาทการเป็นอาจารย์ที่ดี เทคนิคการสอนที่เน้นผู้เรียนเป็นสำคัญ หลักการวัดและประเมินผลการศึกษา และการจัดทำ มคอ. นอกจากนี้ยังมีกิจกรรมสร้างความสัมพันธ์ระหว่างอาจารย์ใหม่ด้วย</td>
                                    <td>เฉพาะอาจารย์ใหม่ที่เริ่มปฏิบัติงานในปีเดือนตุลาคม พ.ศ. 2556- มิถุนายน 2558</td>
                                    <td>วันที่ 16-19 กรกฎาคม 2558 ณ คาทิลิยา เมาท์เทน รีสอร์ท แอนด์สปา </td>
                                    <td></td>
                                    <td></td>
                    ...
                    <br>
                        ...
                        <span>
                            <a class="12u" style="font-size:20px;"> <img src="images/pdf.png" style="width:20px; hieght:auto;"/>
                                <a href="#" >ประกาศการพัฒนาคุณภาพการจัดการเรียนการสอนของอาจารย์มหาวิทยาลัยแม่ฟ้าหลวง.pdf </a> 
                            </a>
                            <small style="font-size:18px; color:#999;"> Update : 3 มิ.ย. 2559 10:15 โดย Academic Extension and Development Office MFU <a  style="text-indent:40px;" class="fa fa-download"></a></small>
                        </span>                      
