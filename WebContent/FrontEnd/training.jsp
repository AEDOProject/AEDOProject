			...
			<div id="logo-wrapper"  style="padding-bottom:125px;">
				<div class="container">
                    ...
                    <div class="wrap-position">
                            ...
                            <div class="wrap-icon">
                                <a  href="#">
                                    <img src="images/7.png" style="width:45px; hieght:auto; margin-left:20%;"/><br>
                            ...
                            <div class="wrap-icon">
                                <a href="#">
                                    <img src="images/4.png" style="width:45px; hieght:auto; margin-left:20%;"/><br>
                                    <center>ทุนวิจัย</center> 
                                </a>
                            </div>
                            <div class="wrap-icon">
                                <a  href="#">
                                    <img src="images/3.png" style="width:45px; hieght:auto; margin-left:20%;"/><br>
                                    <center>ทุนตำรา</center> 
                                </a>
                            </div>
                            <div class="wrap-icon">
                                <a href="#">
                                    <img src="images/2.png" style="width:45px; hieght:auto; margin-left:20%;"/><br>
                                    <center>KM</center> 
                                </a>
                            </div>
                            <div class="wrap-icon">
                                <a  href="trainings.html">
                                    <img src="images/1.png" style="width:45px; hieght:auto; margin-left:20%;"/><br>
                                    <center>อบรม</center> 
                                </a>
                            </div>                         
                         </div>
                    ...
                    <section class="12u">    
                             <center>
                              ...
                              <table class="table table-hover">
                                ...
                                <tbody>
                                  <tr>
                                    <td>1. โครงการแลกเปลี่ยนเรียนรู้เพื่อ สุนทรียภาพเสวนานักสอน ครั้งที่ 1</td>
                                    <td>กิจกรรมแลกเปลี่ยนและแบ่งปันประสบการณ์ด้านการพัฒนาการเรียนการสอนระหว่างคณาจารย์มหาวิทยาลัยแม่ฟ้าหลวง</td>
                                    <td>50</td>
                                  ...
                                  <tr>
                                    <td>2. อบรมเชิงปฎิบัติการ เรื่อง กระบวนการวิจัยในชั้นเรียนเพื่อพัฒนาการเรียนการสอน</td>
                                    <td>แบบตอบรับจากอาจารย์วิชาละ 5 ท่าน แจ้งรายชื่อผ่าน tldc@mfu.ac.th หรือ ผ่านเลขาสำนักวิชา</td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                  ...
                                  <tr>
                                    <td>3. โครงการแลกเปลี่ยนเรียนรู้เพื่อสุนทรียภาพเสวนานักสอน ครั้งที่ 2 เรื่อง “เมื่ออาจารย์ GEN Y ต้องปลดล็อคให้วัย (ร้าย) GEN Z”</td>
                                    <td>มีวัตถุประสงค์เพื่อให้อาจารย์ใหม่มีความเข้าใจและเรียนรู้ถึงแนวทางการปลดล็อคการลงทะเบียนให้นักศึกษาและการให้คำปรึกษาเรื่องการลงทะเบียน</td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                    <td>john@example.com</td>
                                    ...
                                    <tr>
                                    <td>4. โครงการอบรมเชิงปฎิบัติการ เรื่อง ครูสนุก เด็กสนุก หากรู้จัก Learning Style</td>
                                    <td>เสริมสร้างความเข้าใจในการเป็นผู้ให้การศึกษาก้าวทันผู้เรียนในยุค Gen-Z การส่งเสริมให้ผู้เรียนเกิดการเรียนรู้อย่างเต็มที่ และสามารถพัฒนาผู้เรียนตามศักยภาพสูงสุดที่มีอยู่ ซึ่งจะส่งผลให้บัณฑิตที่สำเร็จการศึกษามีคุณภาพและศักยภาพในการนำองค์ความรู้ไปพัฒนาสังคมและประเทศชาติต่อไปได้อย่างมีประสิทธิภาพ</td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                    <td>john@example.com</td>
                                    ...
                                    <tr>
                                    <td>5. โครงการอบรมเชิงปฎิบัติการ เรื่อง "ปรับวิธีคิด เปลี่ยนวิธีสอน"</td>
                                    <td>เพื่อสร้างความรู้ความเข้าใจในการออกแบบการจัดการเรียนรู้ที่เน้นผู้เรียนเป็นสำคัญแก่อาจารย์และสามารถนำไปประยุกต์ใช้ในการเรียนการสอนได้ และเพื่อพัฒนาการจัดการศึกษาของมหาวิทยาลัยแม่ฟ้าหลวงให้มีประสิทธิภาพมากขึ้น</td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                    <td>john@example.com</td>
                                    ...
                                    <tr>
                                    <td>6. โครงการอบรมเชิงปฎิบัติการ เรื่อง "การวัดและการประเมินข้อสอบและวิเคราะห์ข้อสอบ"</td>
                                    <td>มีวัตถุประสงค์เพื่อให้อาจารย์ใหม่มีความเข้าใจและเรียนรู้ถึงแนวทางการปลดล็อคการลงทะเบียนให้นักศึกษาและการให้คำปรึกษาเรื่องการลงทะเบียน </td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                    ...
                                    <tr>
                                    <td>7. โครงการแลกเปลี่ยนเรียนรู้เพื่อ สุนทรียภาพเสวนานักสอน ครั้งที่ 3 เรื่องการวิจัยในชั้นเรียนเพื่อพัฒนาการเรียนการสอน</td>
                                    <td>มีวัตถุประสงค์เพื่อให้อาจารย์ใหม่มีความเข้าใจและเรียนรู้ถึงแนวทางการปลดล็อคการลงทะเบียนให้นักศึกษาและการให้คำปรึกษาเรื่องการลงทะเบียน</td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                    ...
                                    <tr>
                                    <td>8. โครงการอบรมเชิงปฏิบัติการ เรื่อง การใช้เทคโนโลยีเพื่อการเรียนการสอน "Desktop classroom"</td>
                                    <td>มีวัตถุประสงค์เพื่อให้อาจารย์ใหม่มีความเข้าใจและเรียนรู้ถึงแนวทางการปลดล็อคการลงทะเบียนให้นักศึกษาและการให้คำปรึกษาเรื่องการลงทะเบียน </td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
                                    ...
                                    <tr>
                                    <td>9. โครงการแลกเปลี่ยนเรียนรู้เพื่อ สุนทรียภาพเสวนานักสอน ครั้งที่ 3.2 เรื่องการวิจัยเชิงปริมาณทางด้านสังคมศาสตร์</td>
                                    <td>มีวัตถุประสงค์เพื่อให้อาจารย์ใหม่มีความเข้าใจและเรียนรู้ถึงแนวทางการปลดล็อคการลงทะเบียนให้นักศึกษาและการให้คำปรึกษาเรื่องการลงทะเบียน </td>
                                    <td>50</td>
                                    <td>John</td>
                                    <td>Doe</td>
