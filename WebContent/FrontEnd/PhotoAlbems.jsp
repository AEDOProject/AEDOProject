...
<div id="works"  class=" clearfix grid"> 
    ...
    <figure class="effect-oscar  wowload fadeInUp">
        <img src="images/B8wWDzcCAAAskyT.jpg"style="width: 1234px;height:265px" alt="img01"/>
        <figcaption>
            <h2>Dicrap</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href="Templates/thebootstrapthemes-photgraphy/images/portfolio/8.jpg" title="1" data-gallery>View more</a></p>            
        </figcaption>
    </figure>
    <figure class="effect-oscar  wowload fadeInUp">
