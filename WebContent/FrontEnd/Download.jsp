				...
				<div id="sidebar1" class="4u">
						<section>
							...
							<ul class="default alt">								
								<li style="font-family:'Thai Sans Lite'; font-size:21px;">&#9679;<a href="LearningTools.jsp">Forms</a></li>
                                <li style="font-family:'Thai Sans Lite'; font-size:21px;">&#9679;<a href="Surveys.jsp">Useful Documents for Faculty Staff</a></li>
                                <li style="font-family:'Thai Sans Lite'; font-size:21px;">&#9679;<a href="Surveys.jsp">University Announcements/Regulations</a></li>								
							</ul>
						</section>						
					</div> 	
				</div>				
